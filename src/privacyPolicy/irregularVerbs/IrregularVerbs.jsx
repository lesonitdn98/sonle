            ...
            <div className="container">
                <div className="page">
                    <div className="header">
                        <div className="container">
                            <h1 className="pt-5">Privacy Policy for Irregular Verbs</h1>
                        </div>
                    </div>
                        ...
                        <div className="container">
                            <div className="tab-content translations-content-item en visible" id="en">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named Irregular Verbs</p>
                                    </li>
                                    <li>
                                        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Irregular Verbs.</p>
                                    </li>
                                    <li>
                                ...
                                <ul>
                                    <li>By email: lesonitdn98@gmail.com</li>
                                </ul>
                            </div>
                        </div>
                    </div>
